  ...
  <section id="contact" className="page-section">
    ...
    <div className="page-content">
      ...
      <div className="contact-card">
        <p className="mb-4">
          Feel free to reach out for collaboration, project discussion, or opportunities.
        </p>

        <div className="contact-links">
          <a href="mailto:ankithrajgodugu@gmail.com" className="contact-link">
            <Mail /> Email
          </a>

          <a href="https://github.com/ankithrajgodugu" target="_blank" className="contact-link">
            <Github /> GitHub
          </a>

          <a href="https://www.linkedin.com/in/ankith-raj-a90111302/" target="_blank" className="contact-link">
            <Linkedin /> LinkedIn
          </a>
        </div>
      </div>
